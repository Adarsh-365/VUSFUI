...
export const EventsPage: React.FC<EventsPageProps> = ({ onSelectEvent, onMemberClick }) => {
  ...
  const upcomingEvents = [
    ...
    },
    {
      ...
      desc: 'Connecting MMR and Konkan manufacturers, agro-producers, and industrial exporters with direct international buyers, shipping liners, customs clearance specialists, and trade facilitation councils. Organized by Namaste India Group.',
      highlight: 'Organizer: Namaste India Group • Fortune Select Exotica (ITC Hotel)',
