...
export const DETAILED_EVENTS: DetailedEvent[] = [
  {
    ...
    date: 'Phase 1: April 15–19, 2026 | Phase 3: Apr 30–May 7, 2026',
    day: 'Phase 1 (Apr 15–19) & Phase 3 (Apr 30–May 7)',
    ...
    longDescription: [
      ...
      "Seat Limit Approaching: Only 12 registration seats remain for Phase 1 delegation. Deadlines close this month! Choose between Phase 1 (Electronics, Machinery & Hardware: April 15–19, 2026) and Phase 3 (Textiles, Fashion & Health Products: Apr 30–May 7, 2026), or join our complete Double Phase Sourcing Delegation with special discount pricing.",
      "Includes return flights on premium airlines (Singapore/Cathay), 4-star luxury hotel stay in Guangzhou, normal business visa processing support, daily Indian catering dinners, trade interpreters, and dedicated visa rejection protection."
    ],
    stats: [
      { value: '180+', label: 'Importers Served', subtext: 'Indian businesses successfully scaled' },
      { value: '100%', label: 'Visa Success Rate', subtext: 'Full refund protection on refusal' },
    ...
    passes: [
      {
        ...
        shortDesc: 'April 15 - 19, 2026 • Consumer Electronics, Industrial Machinery, Hardware, Tools & Automation.',
        seatsLeft: 12,
      ...
      },
      {
        ...
        gstPercentage: 5,
        badge: '🎉 Early Bird Special - Get 10% OFF',
        shortDesc: 'Apr 30 - May 7, 2026 • Textiles, Fashion, Footwear, Medical Devices & Stationery.',
        seatsLeft: 8,
        dates: 'Apr 30 - May 7, 2026',
        earlyBirdDiscount: 'Get 10% OFF • Contact us for exclusive pricing',
        categories: [
      ...
      {
        id: 'double-phase-package',
        name: 'Double Phase Sourcing Package (Phase 1 + Phase 3)',
        price: 245000,
        gstPercentage: 5,
        badge: '🌟 DOUBLE PHASE SOURCING DISCOUNT',
        shortDesc: 'April 15 - May 7, 2026 • Complete double-phase delegation with visa extension and transfer hotel allowance.',
        seatsLeft: 5,
        dates: 'April 15 - May 7, 2026',
        earlyBirdDiscount: 'Special Sourcing Rate • Contact us for exclusive rates',
        categories: [
          'Full Phase 1 & Phase 3 Category Coverage',
          'Electronics, Machinery, Hardware, Industrial Tools',
          'Textiles, Apparel, Footwear, Medical Devices, Toys',
          'Extended Factory Visits across Guangdong Province',
        ],
        benefits: [
          'Complete access to BOTH Phase 1 (Apr 15-19) & Phase 3 (Apr 30-May 7)',
          'Includes visa extension & hotel allowance for transfer days',
          'Return Flight on Premium Airlines (Singapore/Cathay)',
          '4-Star Luxury Hotel Stay throughout the full delegation',
          'Daily breakfast buffet & Indian catering dinners',
          'Dedicated English-Chinese trade interpreter allocation',
          'Custom sample shipping & logistics guidance to Mumbai',
        ],
      },
    ],
    inclusions: [
    ...
    cancellationPolicy: 'We understand visa processing creates anxiety. In the event of a visa rejection by the Chinese Consulate, Namaste China provides a Full Refund of your package deposit, less a processing/consulate fee of ₹5,000. Book with absolute peace of mind.',
    doublePhaseDiscount: {
      title: 'Double Phase Sourcing Discount',
      description: 'Want to attend both Phase 1 and Phase 3? Register for our complete double-phase delegation with special pricing (includes visa extension and hotel allowance for transfer days). Contact us for exclusive rates.',
      actionText: 'Inquire Double Phase Package',
    },
    consultationBanner: {
    ...
    speakers: [
      ...
      {
        name: 'Kamlesh Kumar',
        designation: 'Managing Director & Vice President',
        organization: 'Vishwa Udyam Sahayta Foundation',
        image: '/members/kamlesh.jpeg',
        expertise: 'International Sourcing, Supply Chain Logistics & OEM Negotiation',
        topic: 'De-Risking Global Supply Chains and Verified Supplier Selection',
      },
      {
        name: 'Bhushan Tayade',
        designation: 'Director of International Relations',
        organization: 'Namaste China Desk',
        image: '/members/bhushan.jpeg',
        expertise: 'Guangdong Industrial Clusters & Customs Clearance',
        topic: 'Mastering Canton Fair: From Booth Discovery to Port of Nhava Sheva',
      },
    ],
    faqs: [
      {
      ...
      {
        question: 'Can I register for both Phase 1 and Phase 3?',
        answer: 'Yes! Register for our complete double-phase delegation with special discounted pricing. It includes visa extension and hotel allowance for transfer days between phases.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Phase 1 (Apr 15–19, 2026) covers Consumer Electronics, Industrial Machinery, Hardware, Tools, Automation, and Lighting. Phase 3 (Apr 30–May 7, 2026) covers Textiles, Fabrics, Garments, Shoes, Travel Bags, Medicines, Devices, Health Products, and Stationery.',
      },
      {
  ...
  },
  {
    ...
    date: 'National Release: 02 October 2026 (Gandhi Jayanti National Issue)',
    ...
    speakers: [
      {
        name: 'Pragati Tayde',
        designation: 'Founder & Publisher',
        organization: 'Namaste Entrepreneur Editorial Council / VUSF',
        image: '/members/pragati.jpeg',
        expertise: 'MSME Advocacy, Media Initiatives & Women Enterprise Growth',
