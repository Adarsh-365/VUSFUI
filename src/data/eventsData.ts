...
export const DETAILED_EVENTS: DetailedEvent[] = [
  {
    ...
    statusBadge: 'EARLY-BIRD DELEGATION BOOKING OPEN',
    eventType: 'INTERNATIONAL TRADE DELEGATION',
    tagline: 'Connect directly with verified Chinese OEM factories, machinery manufacturers, and global suppliers at the world’s largest trade expo.',
    date: 'Phase 1: 15–19 Oct 2026 | Phase 3: 31 Oct–4 Nov 2026',
    day: 'Multi-Day High-Impact Delegation',
    time: '09:00 AM – 06:00 PM (Local Time)',
    ...
    longDescription: [
      'The Canton Fair (China Import and Export Fair) is the largest trade exposition on earth, spanning over 1.5 million square meters with tens of thousands of manufacturers and OEM suppliers across all industrial sectors.',
      'Under the official bilateral platform Namaste China (by Vishwa Udyam Sahayta Foundation), our curated business delegation offers Indian MSMEs, manufacturers, and importers complete end-to-end delegation support—including official fair badges, verified factory tours, bilateral language translation, logistics guidance, and customized B2B supplier matchmaking.',
      'Phase 1 focuses on Electronics, Household Appliances, Machinery, Hardware, and Industrial Automation. Phase 3 focuses on Textiles, Garments, Footwear, Medical Devices, Stationery, and Consumer Goods.'
    ],
    stats: [
      { value: '25,000+', label: 'Verified Global Exhibitors', subtext: 'Direct manufacturers & OEM suppliers' },
      { value: '10 Days', label: 'Bilateral Sourcing Program', subtext: 'Phase 1 & Phase 3 comprehensive access' },
      { value: '50+', label: 'Curated Indian Delegates', subtext: 'Founders, importers & manufacturers' },
      { value: '100%', label: 'Factory & Matchmaking Support', subtext: 'On-ground translators & guidance' },
    ],
    highlights: [
      'Official Indian Trade Delegation Badges & Fast-track Pazhou Entry',
      'Exclusive Factory Visits in Pearl River Delta Industrial Clusters',
      'Dedicated Mandarin/English Business Interpreters & Negotiators',
    ...
    benefits: [
      ...
      {
        number: '02',
        title: 'On-Site Industrial Plant Visits',
      ...
      {
        number: '03',
        title: 'Bilingual Trade Facilitation',
    ...
    agendaTitle: 'A COMPREHENSIVE SOURCING EXPEDITION',
    ...
    agenda: [
      {
        time: 'Day 1: Arrival & Orientation',
        title: 'Guangzhou Welcome & Delegation Briefing',
        description: 'Arrival at Guangzhou Baiyun International Airport, hotel check-in, orientation dinner, and distribution of official Canton Fair entry passes & translator assignments.',
        type: 'delegation',
      },
      {
        time: 'Day 2: Full-Day Expo',
        title: 'Pazhou Complex Phase 1/3 Guided Walkthrough',
        description: 'Targeted hall tours focused on industrial automation, high-precision tooling, electronics, or textiles based on individual delegate profiles.',
        type: 'delegation',
      },
      {
        time: 'Day 3: Bilateral B2B Meetings',
        title: 'Exclusive Supplier Roundtables & Contract Discussions',
        description: 'Pre-scheduled one-on-one sessions with verified Chinese exporters, OEM brand licensors, and technology partners.',
        type: 'networking',
      },
      {
        time: 'Day 4: Factory Tours',
        title: 'Greater Bay Area Industrial Cluster Visits',
        description: 'Site inspection of modern manufacturing facilities, assembly lines, and warehouse distribution centers in Foshan/Dongguan.',
        type: 'delegation',
      },
      {
        time: 'Day 5: Debrief & Logistics',
        title: 'Trade Advisory, Shipping Agreements & Valedictory Dinner',
        description: 'Comprehensive debrief on MoUs signed, freight forwarding tie-ups with logistics partners, and celebratory delegation banquet.',
        type: 'felicitation',
      },
    ],
    passes: [
      {
        ...
        name: 'Standard Delegation Pass',
        price: 145000,
        gstPercentage: 18,
        shortDesc: 'Comprehensive delegation pass for individual founders and business owners.',
        seatsLeft: 12,
        benefits: [
          'Official Canton Fair Buyer Badge & Registration',
          '5-Star Twin-Sharing Hotel Accommodation in Guangzhou',
          'Daily Private Transfers to Pazhou Exhibition Complex',
          'Dedicated Bilingual Business Translator for 3 Days',
          'Welcome & Farewell Networking Banquets',
          'Pre-Fair Supplier Shortlisting & Sourcing Dossier',
          'Post-Fair Logistics & Customs Advisory',
        ],
      },
      {
        id: 'vip-executive',
        name: 'VIP Executive & Factory Pass',
        price: 225000,
        gstPercentage: 18,
        recommended: true,
        badge: 'MOST POPULAR',
        shortDesc: 'Premium single-occupancy pass with curated private factory visits and bespoke matchmaking.',
        seatsLeft: 6,
        benefits: [
          'Everything in Standard Delegation Pass',
          'Private Single Luxury Hotel Room (5-Star)',
          '2 Days Dedicated Private Industrial Factory Visits',
          'Personal Dedicated Translator & Vehicle for 5 Days',
          'VIP Lounge Access at Pazhou Complex',
          'One-on-One Supplier Background & Credit Check',
          'Priority Consultation with VUSF President & Trade Directorate',
        ],
      },
      {
        id: 'corporate-team',
        name: 'Corporate Sourcing Duo (2 Passes)',
        price: 380000,
        gstPercentage: 18,
        shortDesc: 'Designed for enterprise procurement heads and managing directors traveling together.',
        seatsLeft: 4,
        benefits: [
          'All VIP Executive Benefits for 2 Company Executives',
          'Two Private Single Luxury Hotel Rooms',
          'Full-week Chauffeured Private Transport',
          'Custom Supplier Scouting Campaign across Guangdong Province',
          'Sample Verification & Courier Consolidation Support',
    ...
    faqs: [
      {
        question: 'Does the delegation pass include international flights and China visa assistance?',
        answer: 'The delegation pass includes full official invitation letters, documentation support, and visa facilitation via the Chinese Visa Application Service Centre. International flights can be booked independently or coordinated through our designated travel desk partner.',
      },
      {
        question: 'What language support is provided during fair negotiations and factory tours?',
        answer: 'Every delegation group is accompanied by experienced bilingual interpreters fluent in Mandarin and English/Hindi who have specialized knowledge in industrial terminology and trade negotiations.',
      },
      {
        question: 'Will I receive a GST tax invoice for the registration fee?',
        answer: 'Yes. Vishwa Udyam Sahayta Foundation provides an official GST Tax Invoice (with 18% GST itemized) under MCA Section 8 registration credentials upon payment confirmation.',
      },
      {
        question: 'Can I choose specific factories to visit outside Guangzhou?',
        answer: 'Yes. VIP and Corporate pass holders can submit their target product categories and preferred factory regions (such as Foshan, Dongguan, Zhongshan, or Shenzhen) during pre-delegation onboarding.',
      },
      {
        question: 'What is the refund and pass transfer policy?',
        answer: 'Registrations may be transferred to another executive from the same organization up to 14 days before departure with prior notification. Cancellations made 30+ days prior receive an 80% refund; thereafter, travel and accommodation commitments apply.',
      },
      {
        question: 'What if our business requires ongoing sourcing after the fair?',
        answer: 'All delegates receive 6 months of complimentary follow-up support via the permanent Namaste China Desk in Navi Mumbai and our partner offices in China for sample checks and re-order assistance.',
      },
    ],
  ...
  },
  {
    ...
    stats: [
      ...
      { value: '₹50 Lakhs', label: 'Collateral-Free Limit', subtext: 'Under CGTMSE credit mechanisms' },
    ],
    highlights: [
    ...
    benefits: [
      ...
      },
      {
        ...
        description: 'Leverage the CGTMSE framework to secure working capital and term loans up to ₹2 Crores without pledging residential or commercial collateral.',
  ...
  },
  {
    ...
    stats: [
      { value: '₹25 Lakhs', label: 'Avg Seed Fund Grant', subtext: 'Facilitated under SISFS & angel networks' },
    ...
    agenda: [
      ...
      },
      {
        ...
        description: 'How to access non-dilutive government grants up to ₹50 Lakhs under SISFS and state innovation funds.',
        type: 'workshop',
      },
      {
    ...
    passes: [
      ...
      },
      {
        ...
        shortDesc: 'Guaranteed 5-minute pitch slot before the angel investor panel with personalized feedback.',
        seatsLeft: 15,
        benefits: [
          'All Startup Founder Pass Privileges',
          'Guaranteed 5-Minute Pitch Slot in Front of Active Investors',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Yes. Participating investors and angel syndicates actively scout for promising deals for seed cheques ranging from ₹10 Lakhs to ₹50 Lakhs.',
      },
      {
  ...
  },
  {
    ...
    time: '09:30 AM – 05:30 PM IST',
    venue: 'Grand Executive Hall, Sector 18, Vashi',
    ...
    benefits: [
      {
        number: '01',
        title: 'Collateral-Free Bank Financing',
        description: 'Discover how to leverage Stand-Up India and Mahila Udyam Nidhi schemes to secure low-interest loans from ₹10 Lakhs to ₹1 Crore without property mortgage.',
        category: 'Finance & Banking',
      },
      {
        number: '02',
        title: 'Export & Retail Packaging Standards',
        description: 'Upgrade your product packaging, shelf-life preservation, FSSAI compliance, and barcodes to meet international retail standards.',
        category: 'Product Standardization',
      },
      {
        number: '03',
        title: 'Digital Marketing & D2C Sales Channels',
        description: 'Master practical customer acquisition via social media ads, WhatsApp automation, Amazon Global Selling, and ONDC channels.',
        category: 'Digital Commerce',
      },
      {
        number: '04',
        title: 'Institutional & Corporate Gifting Tie-Ups',
        description: 'Get your artisanal, food, fashion, or craft products listed in corporate procurement catalogs and premium exhibition bazaars.',
        category: 'Market Linkage',
      },
      {
        number: '05',
        title: 'Executive Presence & Pitch Mastery',
        description: 'Build confidence in pricing negotiation, boardroom presentations, and managing supplier contracts like seasoned corporate executives.',
        category: 'Leadership Coaching',
      },
      {
        number: '06',
        title: 'Stree Shakti Peer Network & Alliances',
        description: 'Join a vibrant sisterhood of 1,500+ ambitious women entrepreneurs across Maharashtra for cross-promotion and joint ventures.',
        category: 'Sisterhood Network',
      },
    ],
    ...
    agenda: [
      {
        time: '09:30 AM – 10:30 AM',
        title: 'Registration, Stree Shakti Showcase & Tea Reception',
        description: 'Check-in, delegate kit distribution, and informal networking amongst women business leaders.',
        type: 'networking',
      },
      {
        time: '10:30 AM – 12:00 PM',
        title: 'Inaugural Keynote: Scaling Beyond Boundaries',
        description: 'President Pragati Tayde delivers an empowering blueprint on unlocking institutional credit and building resilient businesses.',
        type: 'keynote',
      },
      {
        time: '12:00 PM – 01:30 PM',
        title: 'Finance Clinic: Stand-Up India & Subsidy Sanctions',
        description: 'Senior bank managers explain exact documentation for collateral-free MSME sanctions.',
        type: 'workshop',
      },
      {
        time: '01:30 PM – 02:30 PM',
        title: 'Networking Luncheon & Product B2B Exchange',
        description: 'Exchange business cards, showcase product samples, and discuss collaboration opportunities.',
        type: 'networking',
      },
      {
        time: '02:30 PM – 04:30 PM',
        title: 'Packaging, Branding & E-Commerce Masterclass',
        description: 'Live audit of attendee product packaging with practical improvements for retail shelf appeal.',
        type: 'workshop',
      },
      {
        time: '04:30 PM – 05:30 PM',
        title: 'Stree Shakti Felicitations & Action Roadmap',
        description: 'Presentation of official Program Certificates and joining the Stree Shakti Alliance.',
        type: 'felicitation',
      },
    ],
    passes: [
  ...
  },
  {
    ...
    title: 'Namaste India Entrepreneur Magazine Launch & Media Conclave',
    statusBadge: 'NATIONAL EDITION CONTRIBUTIONS OPEN',
    eventType: 'NATIONAL PUBLICATION & BRAND FELICITATION',
    tagline: 'Feature your enterprise story, innovations, and brand journey in the premier national business publication distributed to policymakers, industry leaders, and trade chambers.',
    date: 'Last Day to Apply: 20 Sep 2026 | Publish: 2 Oct 2026',
    day: 'Friday (National Gandhi Jayanti Edition)',
    time: '11:00 AM – 04:30 PM IST',
    venue: 'Constitution Club of India / National Press Conclave & Digital Pan-India Distribution',
    location: 'Pan-India Distribution & National Launch',
    ...
    longDescription: [
      'Namaste India Entrepreneur Magazine is the official high-circulation business publication by Vishwa Udyam Sahayta Foundation, celebrating India’s most visionary MSME trailblazers, startup founders, exporters, and industrial champions.',
      'The upcoming Free National Edition is being unveiled on 02 October 2026, reaching over 50,000+ business leaders, government ministry officials, DIC directors, export promotion councils, and foreign trade chambers.',
      'Selected entrepreneurs and brands will have their journeys, innovations, and commercial achievements profiled in glossy full-page editorial features, establishing national credibility and unmatched B2B visibility.'
    ],
    stats: [
      { value: '50,000+', label: 'National Print & Digital Reach', subtext: 'Circulated to trade chambers & CXOs' },
      { value: '33+', label: 'State & Bilateral Desks', subtext: 'Pan-India and international circulation' },
      { value: '100%', label: 'Editorial Credibility', subtext: 'Government & industry readership' },
      { value: '100+', label: 'Featured MSME Leaders', subtext: 'Across manufacturing, tech & exports' },
    ],
    highlights: [
      'High-Impact Editorial Profiles & Brand Coverages Written by Senior Business Journalists',
      'Distribution to Ministry of MSME, State DICs, Trade Delegations & Embassies',
      'Digital Interactive Flipbook Edition Distributed to 1,00,000+ Email Subscribers',
    ...
    benefits: [
      {
        number: '01',
        title: 'National Authority & Credibility',
        description: 'Position your company as an established industry authority with an official multi-page feature in a recognized national business publication.',
        category: 'Media & PR',
      },
      {
        number: '02',
        title: 'Direct Reach to Decision-Makers',
        description: 'Get your brand directly in the hands of corporate procurement officers, banking chairmen, state industry secretaries, and foreign trade attachés.',
        category: 'B2B Visibility',
      },
      {
        number: '03',
        title: 'Permanent Digital SEO & Backlinks',
        description: 'Each printed feature is converted into a high-authority digital article on namastevishwaudyam.org with high-domain-authority SEO backlinks.',
        category: 'Digital Reach',
      },
      {
        number: '04',
        title: 'Investor & Partner Trust',
        description: 'Use the official editorial coverage and framed cover plaque as powerful trust-building collateral in investor pitch decks and client proposals.',
        category: 'Social Proof',
      },
      {
        number: '05',
        title: 'Full Reprint & Media Rights',
        description: 'Receive high-resolution print-ready PDFs, digital badges, and publication snippets for use on your website, social media, and product brochures.',
        category: 'Marketing Assets',
      },
      {
        number: '06',
        title: 'Invitation to VIP Launch Ceremony',
        description: 'Attend the official national launch event and network with featured fellow entrepreneurs, dignitaries, and magazine contributors.',
        category: 'VIP Access',
      },
    ],
    agendaTitle: 'EDITORIAL CALENDAR & LAUNCH TIMELINE',
    agendaSubtitle: 'Strict milestone schedule leading up to the grand national release on Gandhi Jayanti.',
    agenda: [
      {
        time: '20 September 2026',
        title: 'Final Deadline for Contributor Submissions & Profiles',
        description: 'Last date for submitting company profile questionnaires, high-res photos, and founder interviews.',
        type: 'workshop',
      },
      {
        time: '25 September 2026',
        title: 'Editorial Review, Fact-Checking & Layout Proofing',
        description: 'Proof copies shared with featured founders for final approval before going to the print press.',
        type: 'workshop',
      },
      {
        time: '02 October 2026 (11:00 AM)',
        title: 'Grand National Launch & Press Conclave',
        description: 'Official unveiling of the Gandhi Jayanti National Edition followed by keynote addresses and distribution.',
        type: 'keynote',
      },
      {
        time: '02 October 2026 (02:30 PM)',
        title: 'Digital Global Release & Subscriber Broadcast',
        description: 'Nationwide digital circulation to 1,00,000+ MSME subscribers and trade chambers.',
        type: 'felicitation',
      },
    ],
    passes: [
      {
        id: 'contributor-pass',
        name: 'Digital Reader & Contributor Pass',
        price: 999,
        gstPercentage: 18,
        shortDesc: 'Digital edition copy and pass to the online launch webinar and Q&A session.',
        seatsLeft: 100,
        benefits: [
          'High-Resolution Digital Edition Copy of the National Issue',
          'Virtual Pass to National Launch Ceremony Livestream',
          'Inclusion in the Namaste India Business Directory Listing',
          'Certificate of Media Contributor',
        ],
      },
      {
        id: 'featured-story-pass',
        name: 'Full-Page Featured Brand Pass',
        price: 9999,
        gstPercentage: 18,
        recommended: true,
        badge: 'HIGH VALUE',
        shortDesc: 'Exclusive 1 full-page editorial story featuring your brand journey, founder photo, and company profile.',
        seatsLeft: 15,
        benefits: [
          'Full-Page Professional Editorial Profile in Print & Digital Editions',
          '5 Complimentary Glossy Hard Copies Dispatched to Your Office',
          'Dedicated SEO-Optimized Article on namastevishwaudyam.org',
          'Framed "Featured in Namaste India" Certificate & Desk Plaque',
          '1 VIP Delegate Pass to the National Launch Ceremony',
        ],
      },
      {
        id: 'cover-profile-pass',
        name: 'Cover Feature & Double-Spread Pass',
        price: 24999,
        gstPercentage: 18,
        shortDesc: 'Premium 2-page double spread with front/inside-cover branding and video interview clip.',
        seatsLeft: 3,
        benefits: [
          '2-Page Comprehensive Double-Spread Feature Story',
          'Prominent Front/Inside-Cover Headline & Brand Logo',
          '15 Hard Copies of the National Edition',
          'Short Video Interview Produced & Broadcast on VUSF Channels',
          '2 VIP Stage Passes to National Launch Conclave with Dignitaries',
        ],
      },
    ],
    targetAudience: [
      { title: 'Visionary MSME Founders', description: 'Showcasing manufacturing excellence, rapid revenue growth, and homegrown innovation.' },
      { title: 'Export Leaders & Importers', description: 'Highlighting cross-border trade operations, international quality standards, and global reach.' },
      { title: 'Tech Startups & D2C Innovators', description: 'Attracting investors, enterprise clients, and top talent with nationwide press coverage.' },
      { title: 'Women & Social Entrepreneurs', description: 'Inspiring the nation with impactful grassroots stories of transformation and enterprise.' },
    ],
    speakers: [
      {
        name: 'Pragati Tayde',
        designation: 'Editor-in-Chief & President',
        organization: 'Namaste India Editorial Board / VUSF',
        image: '/members/pragati.jpeg',
        expertise: 'Media Strategy, MSME Storytelling & Public Alliances',
        topic: 'Amplifying the Voice of Indian MSMEs on National & Global Platforms',
      },
      {
        name: 'Kamlesh Kumar',
        designation: 'Managing Director & Publisher',
        organization: 'Vishwa Udyam Sahayta Foundation',
        image: '/members/kamlesh.jpeg',
        expertise: 'Media Distribution & Corporate Brand Building',
        topic: 'Transforming Brand Visibility into Tangible Commercial Revenue',
      },
    ],
    faqs: [
      {
        question: 'Who writes the article for the featured brand pass?',
        answer: 'Our professional business editorial team conducts a brief interview with you and drafts a polished, journalistic profile. You will review and approve the final draft and layout before printing.',
      },
      {
        question: 'How and where will the physical copies be distributed?',
        answer: 'Physical copies are mailed directly to central & state industry ministries, DIC offices across Maharashtra, foreign trade bureaus, partner banking headquarters, and to the featured founders.',
      },
      {
        question: 'What is the last date to submit our company profile details?',
        answer: 'The strict deadline for editorial profile submissions is 20 September 2026 to ensure print layout finalization for the 02 October 2026 Gandhi Jayanti launch.',
      },
    ],
    supportPhone: '+91-8169080686',
    supportWhatsapp: '+91-8169080686',
  ...
  },
  {
    ...
    passes: [
      ...
      },
      {
        ...
        benefits: [
          ...
          'Guaranteed Slot on the 2027 International Trade Delegation Waitlist',
        ],
      },
      {
    ...
    targetAudience: [
      { title: 'Scaling Women Founders', description: 'Enterprises generating ₹20 Lakhs to ₹10 Crores preparing for their next growth leap.' },
    ...
    passes: [
      ...
      },
      {
        ...
        benefits: [
          ...
          'Guaranteed One-on-One Meetings with Verified Buyer Desks',
  ...
  },
  {
    ...
    passes: [
      ...
      },
      {
        ...
        benefits: [
          ...
          'Guaranteed One-on-One Meetings with International Produce Buyers',
    ...
    speakers: [
      ...
      },
      {
        ...
        topic: 'De-Risking Perishable Logistics and Securing Guaranteed Payment Terms',
      },
    ],
    faqs: [
      {
