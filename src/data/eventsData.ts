...
export const DETAILED_EVENTS: DetailedEvent[] = [
  ...
  },
  {
    ...
    benefits: [
      ...
      {
        number: '03',
        title: 'Exports Through Postal Channel (India Post)',
        description: 'Unlock seamless cross-border shipping, postal export solutions, and opportunities offered by India Post presented by Shri Vipul Mandlesha.',
        category: 'Postal Exports',
      },
      {
        number: '04',
        title: 'Export Incentives & Duty Deferment Schemes',
        description: 'Master cost reduction for manufacturers, exporters and importers with Suresh Kayakkool covering government duty deferment and speedy clearance registrations.',
        category: 'Customs & Incentives',
      },
      {
        number: '05',
    ...
    agendaSubtitle: 'Venue: Fortune Select Exotica, Navi Mumbai (ITC Hotel) | Organizer: Namaste India Group',
    agenda: [
      {
        time: '10:30 AM – 11:10 AM',
        title: 'Opening Ceremony',
        description: 'Welcome Address & Event Commencement | Delegate Registration & Opening Remarks',
        type: 'keynote',
      },
      {
      ...
      },
      {
        ...
        title: 'India Post Session',
        description: 'Speaker: Shri Vipul Mandlesha (Export Head, Export Promotion Team, India Post) | Topic: Exports Through Postal Channel – Opportunities and Solutions Offered by India Post',
        type: 'workshop',
      },
      {
        time: '12:50 PM – 01:30 PM',
        title: 'Export Incentives & Customs',
        description: 'Speaker: Suresh Kayakkool (Cost Reduction for Manufacturers, Exporters & Importers) | Topic: Various Incentives for Exporters, Duty Deferment Schemes of Govt. & Registrations for Speedy Clearances',
        type: 'workshop',
      },
      {
    ...
    passes: [
      {
        ...
        price: 2499,
        gstPercentage: 18,
        shortDesc: 'Full-day access to all technical sessions, export masterclasses, 60+ exhibitor pavilions, and networking lunch.',
        seatsLeft: 45,
        benefits: [
          'Full-Day Access to All 6 Keynote & Technical Sessions',
          'Access to 60+ Exhibitor Product Stalls & Innovation Pavilions',
      ...
      },
      {
        ...
        recommended: true,
        badge: 'MOST POPULAR',
        shortDesc: 'Includes pre-arranged one-on-one buyer meetings, VIP speaker access, and priority seating.',
        seatsLeft: 18,
        benefits: [
      ...
      },
      {
        ...
        price: 15000,
        gstPercentage: 18,
        shortDesc: 'Dedicated 2m x 2m branded exhibition kiosk among 60+ exhibitors to showcase export products to 300+ attendees.',
        seatsLeft: 8,
        benefits: [
          'Branded 2m x 2m Display Booth in the 60+ Exhibitor Pavilion',
          '2 Full VIP Delegate Passes with Networking Lunch Included',
          'Company Logo on Summit Screen, Backdrops & Program Booklet',
          'Opportunity to Distribute Product Catalogs & Samples to All Attendees',
          'Special Mention during the Valedictory & Award Session',
        ],
      },
    ],
    targetAudience: [
    ...
    speakers: [
      ...
      },
      {
        ...
        designation: 'Export Head, Export Promotion Team',
        organization: 'India Post',
        expertise: 'Postal Exports, Dak Ghar Niryat Kendra & Global Logistics',
        topic: 'Exports Through Postal Channel – Opportunities and Solutions Offered by India Post',
      },
      {
        name: 'Suresh Kayakkool',
        designation: 'Cost Reduction for Manufacturers, Exporters & Importers',
        organization: 'Customs & Foreign Trade Regulatory Advisory',
        expertise: 'Export Incentives, Duty Deferment Schemes & Speedy Customs Clearance',
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'The event is officially organized by Namaste India Group, dedicated to connecting Indian businesses to global trade opportunities.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Yes! All delegates can bring compact physical samples or product portfolios. For dedicated booth branding, booking an Exhibition Display Kiosk Pass is recommended.',
      },
    ],
    supportPhone: '+91-8169080686',
    supportWhatsapp: '+91-8169080686',
