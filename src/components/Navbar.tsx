  ...
  const navItems = [
    ...
    },
    {
      ...
      subItems: [
        ...
        { label: 'Namaste China', path: '/services/namaste-china' },
    ...
    },
    {
      ...
      hasDropdown: true,
      subItems: [
        { label: 'India (Anchor Hub)', path: '/namaste-india-group', flag: '/flags/in.jpeg' },
        { label: 'Nepal', path: '/international/nepal', flag: '/flags/np.jpeg' },
        { label: 'China', path: '/international/china', flag: '/flags/cn.jpeg' },
        { label: 'Bangladesh', path: '/international/bangladesh', flag: '/flags/bd.jpeg' },
        { label: 'Sri Lanka', path: '/international/sri-lanka', flag: '/flags/lk.jpeg' },
        { label: 'Thailand', path: '/international/thailand', flag: '/flags/th.jpeg' },
        { label: 'Japan', path: '/international/japan', flag: '/flags/jp.jpeg' },
        { label: 'Vietnam', path: '/international/vietnam', flag: '/flags/vn.jpeg' },
        { label: 'Malaysia', path: '/international/malaysia', flag: '/flags/my.jpeg' },
        { label: 'Singapore', path: '/international/singapore', flag: '/flags/sg.jpeg' },
        { label: 'Indonesia', path: '/international/indonesia', flag: '/flags/id.jpeg' },
        { label: 'Taiwan', path: '/international/taiwan', flag: '/flags/tw.jpeg' },
        { label: 'South Korea', path: '/international/south-korea', flag: '/flags/kr.jpeg' },
        { label: 'UAE', path: '/international/uae', flag: '/flags/ae.jpeg' },
        { label: 'Oman', path: '/international/oman', flag: '/flags/om.jpeg' },
        { label: 'Qatar', path: '/international/qatar', flag: '/flags/qa.jpeg' },
        { label: 'South Africa', path: '/international/south-africa', flag: '/flags/za.jpeg' },
        { label: 'Ethiopia', path: '/international/ethiopia', flag: '/flags/et.jpeg' },
        { label: 'Germany', path: '/international/germany', flag: '/flags/de.jpeg' },
        { label: 'Russia', path: '/international/russia', flag: '/flags/ru.jpeg' },
      ],
    },
    {
